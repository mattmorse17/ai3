export default function InvestTicker() {
  ...
  return (
    <a href="https://wefunder.com/ai.8" target="_blank" rel="noopener noreferrer" className="fixed top-0 left-0 right-0 z-50 block bg-accent text-black text-xs font-bold overflow-hidden whitespace-nowrap h-8 flex items-center no-underline hover:bg-accent-hover transition-colors cursor-pointer">
